// RealT sync logic removed — placeholder file.
// The RealT menu items and their handlers were removed; keep a lightweight placeholder
// to avoid runtime import errors in case other modules reference this file.
console.info('realt-sync.js: RealT sync removed (placeholder)');

export class RealTSync {
    constructor() {
        console.info('RealTSync placeholder instantiated — no operations available.');
    }
    async syncWalletWithFinary() { throw new Error('RealTSync.syncWalletWithFinary is removed'); }
    async deleteAllFinaryRealTTokens() { throw new Error('RealTSync.deleteAllFinaryRealTTokens is removed'); }
}
